...
[`@aws-sdk/client-eks-auth`](https://www.npmjs.com/package/@aws-sdk/client-eks-auth/v/3.1115.0).
...
- @aws-sdk/client-eks-auth v3.1115.0 - [https://cloud-sdk-builds.github.io/?sdk=client-eks-auth&version=3.1115.0](https://cloud-sdk-builds.github.io/?sdk=client-eks-auth&version=3.1115.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks-auth@3.1115.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yMoSbwtKJIFoMoAuDjUfwOo6EZCq9oOCH+weHBw1M1dMDbJRXsESN25Dg8X7igw6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-eks-auth": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks-auth@3.1115.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks-auth@3.1115.0/index.min.mjs": "sha384-yMoSbwtKJIFoMoAuDjUfwOo6EZCq9oOCH+weHBw1M1dMDbJRXsESN25Dg8X7igw6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-eks-auth/blob/refs/tags/3.1115.0/LICENSE
```
