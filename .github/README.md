...
[`@aws-sdk/client-eks-auth`](https://www.npmjs.com/package/@aws-sdk/client-eks-auth/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks-auth@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ufj6xF2VIngMTJfZm/e1fX/6sXWFH2LGZxDCPUir0MCKNjkj1KDftE+oumeHTrlu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-eks-auth": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks-auth@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks-auth@3.622.0/index.min.mjs": "sha384-Ufj6xF2VIngMTJfZm/e1fX/6sXWFH2LGZxDCPUir0MCKNjkj1KDftE+oumeHTrlu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-eks-auth/blob/refs/tags/3.622.0/LICENSE
```
